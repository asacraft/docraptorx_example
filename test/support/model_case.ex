defmodule DocraptorxSample.ModelCase do
  @moduledoc """
  ...
  using do
    quote do
      ...
      import Ecto.Query
      import DocraptorxSample.ModelCase
    end
  end
  ...
  def errors_on(struct, data) do
    ...
    |> Ecto.Changeset.traverse_errors(&DocraptorxSample.ErrorHelpers.translate_error/1)
